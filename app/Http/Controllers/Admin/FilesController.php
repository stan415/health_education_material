...
use App\Http\Requests\Admin\Files\FilesRequest;
use App\Http\Requests\Admin\Files\UpdateOrCreateRequest;
...
class FilesController extends BaseAdminController
{
     ...
     */
    public function detail(FilesRequest $request)
    {
        $id = $request->get('id', '');
     ...
     * @throws \Exception
     */
    public function del(FilesRequest $request)
    {
        $id = $request->get('id');
