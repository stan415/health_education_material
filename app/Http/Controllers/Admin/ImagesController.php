...
use App\Http\Requests\Admin\Images\ImagesRequest;
use App\Http\Requests\Admin\Images\UpdateOrCreateRequest;
use App\Library\Base\BaseAdminController;
use App\Service\Admin\ImagesService;
...
class ImagesController extends BaseAdminController
{
     ...
     * @apiParamExample {json} Request-Example:
        {
            ...
            "file_type": "Images",       文件类型|required
     ...
     */
    public function detail(ImagesRequest $request)
    {
        $id = $request->get('id', '');
     ...
     * @throws \Exception
     */
    public function del(ImagesRequest $request)
    {
        $id = $request->get('id');
